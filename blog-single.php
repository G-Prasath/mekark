...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- start page-title -->
        <section class="page-title blog-cover-seprate">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col col-md-8">
                        <div class="blog-content">
                            <div class="post format-standard-image">
                                ...
                                <h2>Particularly for a country like Japan, which is low on natural resources but lousy with trees</h2>
                                ...
                                <p>The table - Samsa was a travelling salesman - and above it there hung a picture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame. It showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered the whole of her lower arm towards the viewer. Gregor then turned to look out the window at the dull weather. Pitifully thin compared with the size of the rest of him, waved about helplessly as he looked. "What's happened to me?" he thought. It wasn't a dream. His room, a proper human room although a little too small</p>
                                <h3>As proof-of-concept, the consortium is showing off this concept car, which they've dubbed the NCV </h3>
                                <p>Gregor then turned to look out the window at the dull weather. Pitifully thin compared with the size of the rest of him, waved about helplessly as he looked. "What's happened to me?" he thought. It wasn't a dream. His room, a proper human room although a little too small, lay peacefully between its four familiar walls the when gago will go away never</p>
                                <blockquote>
                                    Spread out on the table Samsa was a travelling salesman and above it there hung a picture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame the aging which game over
                            ...
                            <!-- <div class="author-box">
                                ...
                                <div class="author-content">
                                    ...
                                    <p>Showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered the whole of her lower arm towards the viewer. Gregor then turned to look out the window at the dull weather.</p>
                                    <div class="socials">
                            ...
                            <!-- <div class="more-posts">
                                <div class="previous-post">
                                    <a href="#">
                                        ...
                                        <span class="post-name">Muff that covered the whole of her lower arm towards the viewer</span>
                                    </a>
                                </div>
                                <div class="next-post">
                                    <a href="0">
                                        <span class="post-control-link">Next Post</span>
                                        <span class="post-name"> Gregor then turned to look out the window at the dull weather.</span>
                                    </a>
                                </div>
                            </div> -->
                                                ...
                                                <div class="comment-main-area">
                                                    <div class="comment-wrapper">
                                                        <div class="comments-meta">
                                                            <h4>Michel <span class="comments-date">says Oct 13, 2019 at 9:00am</span></h4>
                                                        </div>
                                                        <div class="comment-area">
                                                            <p>Samsa was a travelling salesman - and above it there hung a picture that he had recently cut out of an illustrated magazine and housed in a nicr</p>
