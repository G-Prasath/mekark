...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- start page-title -->
        <section class="page-title electrical">
            <div class="container">
                <div class="row">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Electrical System</li>
          </ol>
        </nav>
        <!-- ---------- Breadcurm -------->
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <div class="details">
                            <p>Electrical system in MEP refers to equipment and materials used in a building's electrical and lighting systems. These systems often include equipment such as switches, transformers, wiring, lighting and controls and are designed to provide safe and reliable power to buildings when effort and precise targets are met. The electrical systems in the MEP are essential to keeping the building operational, as well as to the safety and comfort of the building occupants.</p>
                            <div class="btns">
                    ...
                    <div class="col col-md-6">
                        <div class="right-col">
                            <div class="img-holder">
                                <img src="assets/images/scroll-bar/services/electrical.jpg" alt>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            $images = glob("assets/images/gallery/services/electrical" . "/*.jpg");
