...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- start page-title -->
        <section class="page-title pressure">
            <div class="container">
                <div class="row">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Pressure Part</li>
          </ol>
        </nav>
        <!-- ---------- Breadcurm -------->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="design-h2">
                    Manufacture and Supplier for Pressure Part
                    </h2>
                    <p>Mekark Provide high Quality pressure parts equipment Accessories in Chennai. We are business to business Manufacturer and Supplier for all our customers. Our Service Provider including</p>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                ...
                <ul class="about-cnt p-bold">
                        <li><i class="ti-control-forward"></i>Pressure Vessels</li>
                        <li><i class="ti-control-forward"></i>Jacket Vessels</li>
                        <li><i class="ti-control-forward"></i>Super Heater Coil</li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <ul class="about-cnt p-bold">
                        <li><i class="ti-control-forward"></i>Heat Exchanger</li>
                        <li><i class="ti-control-forward"></i>Economizer Coil</li>
                        <li><i class="ti-control-forward"></i>Copper heater Coil</li>
                    </ul>
                </div>
                <div class="col-md-4">
                <ul class="about-cnt p-bold">
                    <li><i class="ti-control-forward"></i>Evaporator</li>
                    <li><i class="ti-control-forward"></i>Condenser</li>
                    <li><i class="ti-control-forward"></i>Piping & Pipeline Support</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            $images = glob("assets/images/gallery/equipment/prusser-part" . "/*.jpg");
                            foreach($images as $image)
                            {?>
                                <div class="item">
                                    <a href=<?php echo $image ?> data-lightbox="mygallery" data-title="First-Image">
                                        <img src=<?php echo $image ?> alt="Mekark Pressure Parts Equipment Accessories">
                                    </a>
                                </div>
                            <?php
                            }
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-lg-6 col-md-6">
                        <div class="cta-text">
                            <h3>Looking for Pressure Parts Equipment</h3>
                        </div>
                    </div>
