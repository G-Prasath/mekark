...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- start page-title -->
        <section class="page-title career-cover">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col col-lg-5 col-md-6 col-sm-8">
                        <div class="section-title">
                            ...
                            <p class="para">Career Form</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-md-7">
                        <form method="post" action="career-mail.php" id="career-enquiry" enctype="multipart/form-data">
                            ...
                            <div class="form-group fullwidth">
                                <textarea class="form-control" name="msg"  id="note" placeholder="Case Description..." autocomplete="off" required></textarea>
                            </div>
                            <div class="form-group fullwidth">
                                <input type="file" name="resume" accept="application/pdf" id="phone" autocomplete="off" required />
                            </div>
