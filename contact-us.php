...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- start page-title -->
        <section class="page-title contact-us-cover">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col col-lg-5 col-md-6 col-sm-8">
                        <div class="section-title">
                            ...
                            <p class="para">Call Us Or Fill The Form</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-md-7">
                        <form id="blog-enquiry">
                                  ...
                                  <div class="form-group">
                                    <input class="form-control" id="email" type="email" name="email" placeholder="Email" autocomplete="off" required />
                                  </div>

                                  <div class="fullwidth form-group">
                                    <input class="form-control" id="phone" type="text" name="phone" placeholder="Mobile" autocomplete="off" required />
                                  </div>

                                  <div class="fullwidth form-group">
                                    <textarea class="form-control" id="msg" name="msg" placeholder="Message" rows="5" autocomplete="off" required></textarea>
                                  </div>
                                <div class="g-recaptcha mb-3" data-sitekey="6LfZU6clAAAAAGEhlZA-1x8k893ALlXtoDhHYaCl"></div> 
                                  <button type="submit" class="btn btn-primary" name="submit">Send &nbsp;<i class="fa fa-paper-plane-o ml-1"></i></button>
                    ...
                    <div class="col col-md-5">
                        <div class="office-info">
                            <div>
                                <h3>Address</h3>
                                <ul>
                                    <li><i class="ti-location-pin"></i> 15,62nd street, Ashok Nagar, <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chennai-600083</li>
                                </ul>
                            </div>
                            <div>
                                <h3>Phone</h3>
                                <ul>
                                    <li><i class="ti-mobile"></i>+91 97909 24754</li>
                                </ul>
                            </div>
                            <div>
                                <h3>Email</h3>
        ...
        <section class="contact-map-section">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15548.222799493717!2d80.216721!3d13.032125!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267a5e0329dd9%3A0x4235c2dbe32823ec!2sSmart%20Roofs%20and%20Fabs!5e0!3m2!1sen!2sin!4v1679899365884!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </section>
        <!-- end contact-map -->
