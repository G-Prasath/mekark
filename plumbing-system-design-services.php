...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- start page-title -->
        <section class="page-title plumbing">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h1>Plumbing System</h1>
                    </div>
                </div> 
            </div> 
        </section>        
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Plumbing Service</li>
          </ol>
        </nav>
        <!-- ---------- Breadcurm -------->
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <div class="details">
                            <p>Plumbing In MEP, refers to materials and equipment used in a building's water supply, drainage, and waste management. These systems usually include equipment such as pipes, valves, equipment, pumps and water heaters and are designed to be safe and efficient for water supply and proper waste disposal. MEP installation is very important to ensure the health and safety of the occupants of the building and to make the building suitable.</p>
                            <div class="btns">
                    ...
                    <div class="col col-md-6">
                        <div class="right-col">
                            <div class="img-holder">
                                <img src="assets/images/scroll-bar/services/plumbing.jpg" alt>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            $images = glob("assets/images/gallery/services/plumbing" . "/*.jpg");
