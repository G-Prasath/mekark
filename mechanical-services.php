...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- start page-title -->
        <section class="page-title mechanical">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <h1>Mechanical System</h1>
                    </div>
                </div> 
            </div> 
        </section>        
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Mechanical System</li>
          </ol>
        </nav>
        <!-- ---------- Breadcurm -------->
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <div class="details">
                            <p>Mechanical systems (Mechanical, Electrical and Plumbing) in MEP refers to equipment and materials used in the heating, ventilation and air conditioning (HVAC) of a building. These systems usually include equipment such as boilers, chillers, air handling units, ducts and plumbing to maintain indoor temperature, humidity and air quality for a safe and healthy life at home. The mechanical systems in MEP are important for the fitment of the building and the comfort of the users.</p>
                            <div class="btns">
                    ...
                    <div class="col col-md-6">
                        <div class="right-col">
                            <div class="img-holder">
                                <img src="assets/images/scroll-bar/services/mechanical.jpg" alt>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                        <div class="section-title-s5">
                            <span>Gallery</span>
                            <p class="para">Our Completeing Projects</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            $images = glob("assets/images/gallery/services/mechanical" . "/*.jpg");
