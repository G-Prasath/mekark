                ...
                <div class="row">
                    <div class="col col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2">
                        <div class="section-title-s5">
                            ...
                            <p class="para">Industrial News</p>
                        ...
                        <div class="blog-grids">
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="assets/images/blog/img-1.jpg" alt="Industrial Manufacturing Company India - Mekark">
                                </div>
                            ...
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="assets/images/blog/img-2.jpg" alt="Industrial Manufacturing Company India - Mekark">
                                </div>
                                <div class="entry-body">
                                    <div class="cats">Industry, Factory</div>
                            ...
                            <div class="grid">
                                <div class="entry-media">
                                    <img src="assets/images/blog/img-3.jpg" alt="Industrial Manufacturing Company India - Mekark">
                                </div>
                                <div class="entry-body">
                                    <div class="cats">Industry, Factory</div>
