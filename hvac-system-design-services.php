    ...
    <div class="page-wrapper">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Heating ventilation and Air Conditioning (HVAC)</li>
          </ol>
        </nav>
        <!-- ---------- Breadcurm -------->
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-md-6">
                        ...
                        <div class="details">
                            <p>HVAC (Heating, Ventilation, and Air Conditioning) systems in MEP refer to equipment and materials used in the building's heating, cooling and air control systems. These systems often include equipment such as boilers, chillers, air handling units, ducts and thermostats and are designed to provide a safe and healthy home by controlling temperature, humidity and air quality in the home. HVAC systems in MEP are important to make the building convenient and comfortable for occupants.</p>
                            <div class="btns">
                    ...
                    <div class="col col-md-6">
                        <div class="right-col">
                            <div class="img-holder">
                                <img src="assets/images/scroll-bar/services/hvac.jpg" alt>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            $images = glob("assets/images/gallery/services/hvac" . "/*.jpg");
